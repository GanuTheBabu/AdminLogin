  ...
  <div id="wrapper">
    ...
    <ul class="sidebar navbar-nav">
      <li class="nav-item active">
        <a class="nav-link" href="dashboardforsafety.php">
          <i class="fas fa-fw fa-tachometer-alt"></i>
          <span> Dashboard</span>
        </a>
      </li>
      <li class="nav-item active">
        <a class="nav-link" href="openforsafety.php">
          <i class="fas fa-fw fa-lock-open"></i>
          <span> Open</span>
        </a>
      </li>
      <li class="nav-item active">
        <a class="nav-link" href="verifyforsafety.php">
          <i class="fa fa-fw fa-anchor"></i>
          <span> Verify</span>
        </a>
      </li>
      <li class="nav-item active">
        <a class="nav-link" href="closedforsafety.php">
